...
namespace OnlineCoursePlatfrom.Persistence.InregrationTests
{
    public class CourseRepositoryTests
    {
        ...
        public async Task GetCoursesByCategoryId_ShouldReturnCoursesOfGivenCategory()
        {
            ...
            var result = await _repository.GetCoursesByCategoryAsync(categoryId);
        ...
        public async Task GetCourseByLessonId_ShouldReturnCoursesOfGivenCategory()
        {
            ...
            var result = await _repository.GetCourseAsync(new CourseFilter() { LessonId = lessonId });

            Assert.NotNull(result);
            Assert.Equal(lessonId, result.Lessons.First().Id);
        }
