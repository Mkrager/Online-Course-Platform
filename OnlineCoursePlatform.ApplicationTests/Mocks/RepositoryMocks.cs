...
namespace OnlineCoursePlatform.ApplicationTests.Mocks
{
    public class RepositoryMocks
    {
        ...
        public static Mock<IAsyncRepository<Lesson>> GetLessonRepository()
        {
            var lessons = new List<Lesson>
            {
                new Lesson { Id = Guid.Parse("b8c3f27a-7b28-4ae6-94c2-91fdc33b77e8"), Title = "test", Description = "test" },
                new Lesson { Id = Guid.Parse("b8c3f27a-7b28-4ae6-94c2-91fdc33b77e2"), Title = "test2", Description = "test2" }

            };

            var mockRepository = new Mock<IAsyncRepository<Lesson>>();
