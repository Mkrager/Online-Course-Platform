...
namespace OnlineCoursePlatform.Persistence.Migrations
{
    ...
    [Migration("20250716105108_AddStudentsIdToEnrollmentEtity")]
    partial class AddStudentsIdToEnrollmentEtity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OnlineCoursePlatform.Domain.Entities.TestAttempt", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsCompleted = false,
                            StartTime = new DateTime(2025, 7, 16, 13, 51, 7, 618, DateTimeKind.Local).AddTicks(1251),
                            TestId = new Guid("4a8c1a3f-7e1c-49d3-9bc1-1f8b38f1f3aa"),
                            UserId = "someUserId"
                        });
                });
