...
namespace OnlineCoursePlatform.Persistence.Migrations
{
    ...
    [Migration("20250721124944_ChangeStringOrderStatusToOrderStatusEnum")]
    partial class ChangeStringOrderStatusToOrderStatusEnum
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OnlineCoursePlatform.Domain.Entities.TestAttempt", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsCompleted = false,
                            StartTime = new DateTime(2025, 7, 21, 15, 49, 43, 862, DateTimeKind.Local).AddTicks(5688),
                            TestId = new Guid("4a8c1a3f-7e1c-49d3-9bc1-1f8b38f1f3aa"),
                            UserId = "someUserId"
                        });
                });
